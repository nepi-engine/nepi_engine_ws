...
if [ "${NEPI_REMOTE_SETUP}" == "0" ]; then
  ...
  --exclude src/nepi_edge_sdk_nav_pose/num_gpsd/gpsd-* 
  --exclude src/nepi_edge_sdk_nav_pose/num_gpsd/.sconf_temp \
  --exclude src/nepi_edge_sdk_nav_pose/num_gpsd/contrib/ais-samples \
  --exclude src/nepi_edge_sdk_nav_pose/num_gpsd/contrib/test \
  --exclude src/nepi_edge_sdk_nav_pose/num_gpsd/man \
  --exclude src/nepi_edge_sdk_nav_pose/num_gpsd/tests \
  --exclude src/nepi_edge_sdk_nav_pose/num_gpsd/test \
